        ...
        <div class="booking-card">
            <form method="POST" action="{{ route('user.store.appointment') }}" class="booking-form">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="date" class="form-input @error('appointment_date') input-error @enderror"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-input form-textarea @error('notes') input-error @enderror" id="notes" name="notes"
                        rows="4" placeholder="Please describe your dental issue or any specific concerns">{{ old('notes') }}</textarea>
                    @error('notes')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="info-alert">
                    ...
                    <div class="alert-content">
                        <strong>Important:</strong> This is a request for an appointment. Our staff will contact you to
                        confirm the exact date and time based on availability.
                    </div>
                </div>
