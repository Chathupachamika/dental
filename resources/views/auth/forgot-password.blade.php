...
<body class="bg-gradient-to-br from-blue-500 to-indigo-600">
    ...
    <div class="w-full max-w-md mx-auto px-4">
        <div class="auth-card animate-fade-in">
            <div class="forgot-illustration animate-slide-up">
                <div class="forgot-icon">
                    <i class="fas fa-key"></i>
                </div>
            </div>

            <div class="auth-heading animate-slide-up">Forgot Password</div>
            ...
            <form method="POST" action="{{ route('password.email') }}" class="animate-slide-up">
                @csrf
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-paper-plane btn-icon"></i> Send Password Reset Link
                </button>
            </form>
